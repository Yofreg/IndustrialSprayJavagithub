 ...
 */
public class Print4Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print4, container, false);
    ...
    private void initView() {
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print4);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(4);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint4(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(4);
    }
}
