 ...
 */
public class Print5Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print5, container, false);
    ...
    private void initView() {
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print5);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(5);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint5(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(5);
    }
}
