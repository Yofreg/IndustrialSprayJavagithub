 ...
 */
public class Print7Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print7, container, false);
    ...
    private void initView() {
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print7);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(7);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint7(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(7);
    }
}
