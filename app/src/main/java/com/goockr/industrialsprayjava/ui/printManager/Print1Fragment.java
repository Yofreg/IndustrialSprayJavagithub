 ...
 */
public class Print1Fragment extends BaseFragment {
    ...
    @BindView(R.id.muzzleLevel)
    RadioGroup muzzleLevel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print1, container, false);
    ...
    private void initView() {
        ...
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print1);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(1);
                //BaseUtils.StoppageSetting(2);
                break;
...
//            loadFor
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint1(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(1);
    }
