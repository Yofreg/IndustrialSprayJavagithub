 ...
 */
public class Print6Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print6, container, false);
    ...
    private void initView() {
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print6);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(6);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint6(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(6);
    }
}
