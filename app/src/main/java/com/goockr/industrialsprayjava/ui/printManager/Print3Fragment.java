 ...
 */
public class Print3Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print3, container, false);
    ...
    private void initView() {
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print3);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(3);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint3(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(3);
    }
