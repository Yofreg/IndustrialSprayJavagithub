 ...
 */
public class Print2Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_print2, container, false);
    ...
    private void initView() {
        ...
        JSONObject object = JSONObject.parseObject(PreferenceUtils.getInstance().print2);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.PrintCancel1:
                ...
                PrintParamarsFragment.getInstance().showHindMain(2);
                break;
    ...
    private void SavePrintSetting() {
        ...
        PreferenceUtils.getInstance().setPrint2(jsonObject.toJSONString());

        MainActivity.getInstance().sendPZCS(2);
    }
