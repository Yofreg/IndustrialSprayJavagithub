 ...
 * @desc socket本地通讯 第八个喷头
 */
public class LocalControler8 implements Runnable {
    ...
    private void pwsend(byte[] f) throws IOException {
        ...
        if (timer == null) {
            ...
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    SocketBeanFS.ebeanFS("服务器无返回", 8, 0);

                }
            }, 2000);
        }
        SocketIsAndOs.OsWrite(pw, f, 8);
    }
    ...
    public void send(byte type, byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 1);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 2);
        }
    }
    ...
    public void sendQDDY(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 3);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 4);
        }
    }
    ...
    public void sendSZCS(byte[] datas) {
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 17);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 18);
        }
    }
    ...
    public void sendCSTP(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                if (timer2 == null) {
                    ...
                    timer2.schedule(new TimerTask() {
                        ...
                        public void run() {
                                ...
                                SocketBeanFS.ebeanFS("服务器无返回", 8, 1);
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 5);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 6);
        }
    }
    ...
    public void sendKZDY(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 7);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 8);
        }
    }
    ...
    public void sendSCXX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 9);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 10);
        }
    }
    ...
    public void sendCXXX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 11);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 12);
        }
    }
    ...
    public void sendSJCX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 13);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 14);
        }
    }
    ...
    private void initSocket() {
        try {
            ...
            mSocket = new Socket(PMJBasicCons.DATA_IP8, PMJBasicCons.DATA_PORT);
            ...
            if (mSocket.isConnected()) {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 8, 15);
            }

        } catch (IOException e) {
            SocketBeanFS.ebeanFS("通讯连接不上", 8, 16);
        }
        //循环获取设备传递的数据
        while (isRun){
            try {
                if (is != null) {
                    ...
                    if (rcvLen != -1) {
                        ...
                        String a = SocketIsAndOs.isRead(rcvLen, buff, 8, timer, timer2);
                        if (a.contains("1")) {
                            if (timer != null) {
                                timer.cancel();
                                timer = null;
