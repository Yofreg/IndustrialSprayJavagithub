 ...
 * @desc socket本地通讯 第七个喷头
 */
public class LocalControler7 implements Runnable {
    ...
    private void pwsend(byte[] f) throws IOException {
        ...
        if (timer == null) {
            ...
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    SocketBeanFS.ebeanFS("服务器无返回", 7, 0);

                }
            }, 2000);
        }
        SocketIsAndOs.OsWrite(pw, f, 7);
    }
    ...
    public void send(byte type, byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 1);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 2);
        }
    }
    ...
    public void sendQDDY(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 3);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 4);
        }
    }
    ...
    public void sendSZCS(byte[] datas) {
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 17);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 18);
        }
    }
            ...
            try {
                ...
                if (timer2 == null) {
                    ...
                    timer2.schedule(new TimerTask() {
                        @Override
                        public void run() {
                            SocketBeanFS.ebeanFS("服务器无返回", 7, 1);
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 5);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 6);
        }
    }
    ...
    public void sendKZDY(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 7);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 8);
        }
    }
    ...
    public void sendSCXX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 9);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 10);
        }
    }
    ...
    public void sendCXXX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 11);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 12);
        }
    }
    ...
    public void sendSJCX(byte[] datas){
        ...
        if (mSocket != null && mSocket.isConnected()) {
            try {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 13);
            }
        } else {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 14);
        }
    }
    ...
    private void initSocket() {
        try {
            ...
            mSocket = new Socket(PMJBasicCons.DATA_IP7, PMJBasicCons.DATA_PORT);
            ...
            if (mSocket.isConnected()) {
                ...
                SocketBeanFS.ebeanFS("通讯连接不上", 7, 15);
            }

        } catch (IOException e) {
            SocketBeanFS.ebeanFS("通讯连接不上", 7, 16);
        }
        //循环获取设备传递的数据
        while (isRun){
            try {
                if (is != null) {
                    ...
                    if (rcvLen != -1) {
                        ...
                        String a = SocketIsAndOs.isRead(rcvLen, buff, 7, timer, timer2);
                        if (a.contains("1")) {
                            if (timer != null) {
                                timer.cancel();
                                timer = null;
